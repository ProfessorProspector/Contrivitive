...
public class RenderUtils {
	...
	public static void drawEntityFacingMouse(IContrivitiveGui gui, int x, int y, int scale, int mouseX, int mouseY, EntityLivingBase entity) {
		x = adjustX(gui, x);
		y = adjustY(gui, y);
		drawEntityOnScreen(x, y, scale, (float) x - mouseX, (float) y - (float) (50 / 30) * scale - mouseY, entity);
	}
